...
type SSV0000010I struct {
	...
	DccMediumNumber   string `validate:"max=30" json:"dccMediumNumber" description:"Dcc medium number"`          //介质号码
	DccMediumType     string `validate:"max=3" json:"dccMediumType" description:"Dcc medium type"`               //介质类型
	DccAgreement      string `validate:"required,max=30" json:"dccAgreement" description:"Dcc agreement"`        //合约号
	...
	DccDate           string `validate:"required" json:"dccDate" description:"Dcc date"`                         //控制日期
	DccOrganize       string `json:"dccOrganize" description:"Dcc organize"`                                     //控制机构
	DccOrganizeName   string `validate:"required,max=60" json:"dccOrganizeName" description:"Dcc organize name"` //控制机构名称
