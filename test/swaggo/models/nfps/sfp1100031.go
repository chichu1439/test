...
func (*FP110031I) GetServiceKey() string {
	return "FP110031"
}

type FP110031O struct {
	ClrSysRef             string `json:"clrSysRef" `
	ClrSysId              string `json:"clrSysId" `
	MsgId                 string `json:"msgId" `
	FromMemberId          string `json:"fromMemberId" `
...
type FP110031Outgress struct {
	Body []byte `json:"body"`
}

func (*FP110031Outgress) GetServiceKey() string {
	return "FP210031"
}

type FP110031OutgressResponse struct {
	Body []byte `json:"body"`
}
