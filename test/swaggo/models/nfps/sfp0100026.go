...
var SpecCredit0200 = &iso8583.MessageSpec{
	...
	Fields: map[int]field.Field{
		...
		43: field.NewComposite(&field.Spec{
			...
			Subfields: map[string]field.Field{
				...
				"7": field.NewString(&field.Spec{ // 05
					Length:      2,
		...
		48: field.NewComposite(&field.Spec{
			...
			Subfields: map[string]field.Field{
				...
				"7": field.NewString(&field.Spec{
					Length:      128,
					Description: "Biller ID  (Proxy ID) ",
					Enc:         encoding.ASCII,
					Pref:        prefix.ASCII.Fixed,
					Pad:         Right(' '),
				}),
				...
				"9": field.NewString(&field.Spec{
					Length:      3,
					Description: "Sponsor Bank of Biller",
					Enc:         encoding.ASCII,
					Pref:        prefix.ASCII.Fixed,
					Pad:         Right(' '),
				}),
				...
				"11": field.NewString(&field.Spec{
					Length:      50,
					Description: "To Account Display Name",
					Enc:         encoding.ASCII,
					Pref:        prefix.ASCII.Fixed,
					Pad:         Right(' '),
				}),
				...
				"19": field.NewString(&field.Spec{
					Length:      100,
					Description: "Credit Guarantee Document URL",
					Enc:         encoding.ASCII,
					Pref:        prefix.ASCII.Fixed,
					Pad:         Right(' '),
				}),
				...
				//"22": field.NewString(&field.Spec{
				//	Length:      6,
				//	Description: "Sending Bank Branch Code",
				//	Enc:         encoding.ASCII,
				//	Pref:        prefix.ASCII.Fixed,
				//	Pad:         Right(' '),
				//}),
				...
				//"24": field.NewString(&field.Spec{
				//	Length:      6,
				//	Description: "Receiver Bank Branch Code",
				//	Enc:         encoding.ASCII,
				//	Pref:        prefix.ASCII.Fixed,
				//	Pad:         Right(' '),
				//}),
				...
				//"31": field.NewString(&field.Spec{
				//	Length:      1,
				//	Description: "Withholding Tax Conditions",
				//	Enc:         encoding.ASCII,
				//	Pref:        prefix.ASCII.Fixed,
				//	Pad:         Right(' '),
				//}),
...
type ISO8583Credit0200Data struct {
	F0   *field.String //0210 Credit Notification response
	F1   *field.Bitmap
	F2   *field.String
	F3   *field.String //340000(00 – Default, 10 – Saving, 20 – Checking, 30 – Credit)
	F4   *field.String
	F5   *field.String
	F6   *field.String
	F7   *field.String
	...
	F41  *field.String
	F42  *field.String
	F43  *ISO8583Credit0200F43Data
	F44  *field.String
	F45  *field.String
	F46  *field.String
	F47  *field.String
	F48  *ISO8583Credit0200F48Data
	F49  *field.String
	F50  *field.String
	F51  *field.String
	F52  *field.String
...
type ISO8583Credit0210Data struct {
	F0   *field.String
	F1   *field.Bitmap
	F2   *field.String
	F3   *field.String
	...
	F41  *field.String
	F42  *field.String
	F43  *ISO8583Credit0210F43Data
	F44  *field.String
	F45  *field.String
	F46  *field.String
	F47  *field.String
	F48  *ISO8583Credit0210F48Data
	F49  *field.String
	F50  *field.String
	F51  *field.String
	F52  *field.String
...
type ISO8583Credit0210F62Data struct {
	F1  *field.String
	F2  *field.String
	F3  *field.String
	F4  *field.String
...
type ISO8583Credit0200F62Data struct {
	F1  *field.String
	F2  *field.String
	F3  *field.String
	F4  *field.String
...
type ISO8583Credit0210F43Data struct {
	F1 *field.String
	F2 *field.String
	F3 *field.String
	F4 *field.String
...
type ISO8583Credit0200F43Data struct {
	F1 *field.String
	F2 *field.String
	F3 *field.String
	F4 *field.String
...
type ISO8583Credit0210F48Data struct {
	F1  *field.String
	F2  *field.String
	F3  *field.String
	F4  *field.String
...
type ISO8583Credit0200F48Data struct {
	F1  *field.String
	F2  *field.String
	F3  *field.String
	F4  *field.String
