...
import (
	"isaving-swagger/models/xml"
	"strconv"
)

type FP010001I struct {
	...
	FP010001IDoc FP010001IDoc `xml:"FpsPylds>BizData>Document"`
}
...
func (a AmtField) GetAmount() float64 {
	amt, err := strconv.ParseFloat(a.Amt, 64)
	if err != nil {
		return 0.0
	}
	return amt
