...
type FpsAcmt024 struct {
	...
	Document Acmt024Doc `xml:"BizData>Document,omitempty"`
}
type Acmt024Doc struct {
	IdVrfctnRpt struct {
		...
		} `xml:"OrgnlAssgnmt,omitempty"`
		Rpt struct {
			OrgnlId string `xml:"OrgnlId,omitempty"`
			Vrfctn  bool   `xml:"Vrfctn,omitempty"`
			Rsn     struct {
				Cd    string `xml:"Cd,omitempty"`
				Prtry string `xml:"Prtry,omitempty"`
			} `xml:"Rsn,omitempty"`
			...
			} `xml:"OrgnlPtyAndAcctId,omitempty"`
			...
			} `xml:"UpdtdPtyAndAcctId,omitempty"`
		} `xml:"Rpt,omitempty"`
		SplmtryData struct {
