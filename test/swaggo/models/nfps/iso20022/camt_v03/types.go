...
func (r StandingOrderQueryType1Code) Validate() error {
	...
	return util.NewErrValueInvalid("StandingOrderQueryType1Code")
}
...
func (r ExternalBillingBalanceType1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalBillingBalanceType1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalBillingCompensationType1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalBillingCompensationType1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalBillingRateIdentification1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalBillingRateIdentification1Code", 1, 4)
	}
	return nil
}
...
func (r CompensationMethod1Code) Validate() error {
	...
	return util.NewErrValueInvalid("CompensationMethod1Code")
}
...
func (r BillingSubServiceQualifier1Code) Validate() error {
	...
	return util.NewErrValueInvalid("BillingSubServiceQualifier1Code")
}
...
func (r BillingTaxCalculationMethod1Code) Validate() error {
	...
	return util.NewErrValueInvalid("BillingTaxCalculationMethod1Code")
}
...
func (r BillingStatementStatus1Code) Validate() error {
	...
	return util.NewErrValueInvalid("BillingStatementStatus1Code")
}
...
func (r BillingCurrencyType1Code) Validate() error {
	...
	return util.NewErrValueInvalid("BillingCurrencyType1Code")
}
...
func (r BillingCurrencyType2Code) Validate() error {
	...
	return util.NewErrValueInvalid("BillingCurrencyType2Code")
}
...
func (r BillingChargeMethod1Code) Validate() error {
	...
	return util.NewErrValueInvalid("BillingChargeMethod1Code")
}
...
func (r BalanceAdjustmentType1Code) Validate() error {
	...
	return util.NewErrValueInvalid("BalanceAdjustmentType1Code")
}
...
func (r AccountLevel1Code) Validate() error {
	...
	return util.NewErrValueInvalid("AccountLevel1Code")
}
...
func (r AccountLevel2Code) Validate() error {
	...
	return util.NewErrValueInvalid("AccountLevel2Code")
}
...
func (r ServiceAdjustmentType1Code) Validate() error {
	...
	return util.NewErrValueInvalid("ServiceAdjustmentType1Code")
}
...
func (r ServicePaymentMethod1Code) Validate() error {
	...
	return util.NewErrValueInvalid("ServicePaymentMethod1Code")
}
...
func (r ServiceTaxDesignation1Code) Validate() error {
	...
	return util.NewErrValueInvalid("ServiceTaxDesignation1Code")
}
