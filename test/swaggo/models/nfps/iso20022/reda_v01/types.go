...
func (r ExternalCreditorEnrolmentAmendmentReason1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalCreditorEnrolmentAmendmentReason1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalCreditorEnrolmentCancellationReason1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalCreditorEnrolmentCancellationReason1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalDebtorActivationAmendmentReason1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalDebtorActivationAmendmentReason1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalDebtorActivationCancellationReason1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalDebtorActivationCancellationReason1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalDebtorActivationStatusReason1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalDebtorActivationStatusReason1Code", 1, 4)
	}
	return nil
}
...
func (r ServiceRequestStatus1Code) Validate() error {
	...
	return util.NewErrValueInvalid("ServiceRequestStatus1Code")
}
...
func (r PresentmentType1Code) Validate() error {
	...
	return util.NewErrValueInvalid("PresentmentType1Code")
}
