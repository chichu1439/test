...
func (r SystemEventType2Code) Validate() error {
	...
	return util.NewErrValueInvalid("SystemEventType2Code")
}
...
func (r CaseForwardingNotification3Code) Validate() error {
	...
	return util.NewErrValueInvalid("CaseForwardingNotification3Code")
}
...
func (r CaseStatus2Code) Validate() error {
	...
	return util.NewErrValueInvalid("CaseStatus2Code")
}
...
func (r ReservationType1Code) Validate() error {
	...
	return util.NewErrValueInvalid("ReservationType1Code")
}
...
func (r FloorLimitType1Code) Validate() error {
	...
	return util.NewErrValueInvalid("FloorLimitType1Code")
}
...
func (r CancellationReason5Code) Validate() error {
	...
	return util.NewErrValueInvalid("CancellationReason5Code")
}
...
func (r ExternalTaxAmountType1Code) Validate() error {
	if len(string(r)) < 1 {
		return util.NewErrTextLengthInvalid("ExternalTaxAmountType1Code", 1, 0)
	}
	return nil
}
...
func (r ExternalPurpose1Code) Validate() error {
	if len(string(r)) < 1 {
		return util.NewErrTextLengthInvalid("ExternalPurpose1Code", 1, 0)
	}
	return nil
}
...
func (r Instruction3Code) Validate() error {
	...
	return util.NewErrValueInvalid("Instruction3Code")
}
...
func (r ExternalDiscountAmountType1Code) Validate() error {
	if len(string(r)) < 1 {
		return util.NewErrTextLengthInvalid("ExternalDiscountAmountType1Code", 1, 0)
	}
	return nil
}
...
func (r ExternalDocumentLineType1Code) Validate() error {
	if len(string(r)) < 1 {
		return util.NewErrTextLengthInvalid("ExternalDocumentLineType1Code", 1, 0)
	}
	return nil
}
...
func (r ExternalGarnishmentType1Code) Validate() error {
	if len(string(r)) < 1 {
		return util.NewErrTextLengthInvalid("ExternalGarnishmentType1Code", 1, 0)
	}
	return nil
}
...
func (r ExternalMandateSetupReason1Code) Validate() error {
	if len(string(r)) < 1 {
		return util.NewErrTextLengthInvalid("ExternalMandateSetupReason1Code"+
			"", 1, 0)
	}
	return nil
}
