...
func (r CommunicationMethod2Code) Validate() error {
	...
	return util.NewErrValueInvalid("CommunicationMethod2Code")
}
...
func (r CommunicationMethod3Code) Validate() error {
	...
	return util.NewErrValueInvalid("CommunicationMethod3Code")
}
...
func (r ExternalCommunicationFormat1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalCommunicationFormat1Code", 1, 4)
	}
	return nil
}
...
func (r Frequency7Code) Validate() error {
	...
	return util.NewErrValueInvalid("Frequency7Code")
}
...
func (r Unlimited9Text) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 9 {
		return util.NewErrTextLengthInvalid("Unlimited9Text", 1, 9)
	}
	return nil
}
...
func (r Modification1Code) Validate() error {
	...
	return util.NewErrValueInvalid("Modification1Code")
}
...
func (r BalanceTransferWindow1Code) Validate() error {
	...
	return util.NewErrValueInvalid("BalanceTransferWindow1Code")
}
...
func (r BusinessDayConvention1Code) Validate() error {
	...
	return util.NewErrValueInvalid("BusinessDayConvention1Code")
}
...
func (r Frequency10Code) Validate() error {
	...
	return util.NewErrValueInvalid("Frequency10Code")
}
...
func (r Gender1Code) Validate() error {
	...
	return util.NewErrValueInvalid("Gender1Code")
}
...
func (r OrganisationLegalStatus1Code) Validate() error {
	...
	return util.NewErrValueInvalid("OrganisationLegalStatus1Code")
}
...
func (r PersonIdentificationType5Code) Validate() error {
	...
	return util.NewErrValueInvalid("PersonIdentificationType5Code")
}
...
func (r ResidentialStatus1Code) Validate() error {
	...
	return util.NewErrValueInvalid("ResidentialStatus1Code")
}
...
func (r SwitchType1Code) Validate() error {
	...
	return util.NewErrValueInvalid("SwitchType1Code")
}
...
func (r TaxRateMarker1Code) Validate() error {
	...
	return util.NewErrValueInvalid("TaxRateMarker1Code")
}
...
func (r SwitchStatus1Code) Validate() error {
	...
	return util.NewErrValueInvalid("SwitchStatus1Code")
}
...
func (r ExternalCategoryPurpose1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 5 {
		return util.NewErrTextLengthInvalid("ExternalCategoryPurpose1Code", 1, 5)
	}
	return nil
}
...
func (r PaymentMethod3Code) Validate() error {
	...
	return util.NewErrValueInvalid("PaymentMethod3Code")
}
...
func (r UseCases1Code) Validate() error {
	...
	return util.NewErrValueInvalid("UseCases1Code")
}
