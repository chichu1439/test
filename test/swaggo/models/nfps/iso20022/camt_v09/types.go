...
func (r ExternalClaimNonReceiptRejection1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalClaimNonReceiptRejection1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalInvestigationExecutionConfirmation1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalInvestigationExecutionConfirmation1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalPaymentCancellationRejection1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalPaymentCancellationRejection1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalPaymentCompensationReason1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalPaymentCompensationReason1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalPaymentModificationRejection1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalPaymentModificationRejection1Code", 1, 4)
	}
	return nil
}
