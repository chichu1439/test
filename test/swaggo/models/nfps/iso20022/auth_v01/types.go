...
func (r InvestigationStatus1Code) Validate() error {
	...
	return util.NewErrValueInvalid("InvestigationStatus1Code")
}
...
func (r TransactionRequestType1Code) Validate() error {
	...
	return util.NewErrValueInvalid("TransactionRequestType1Code")
}
...
func (r StatusResponse1Code) Validate() error {
	...
	return util.NewErrValueInvalid("StatusResponse1Code")
}
...
func (r InvestigatedParties1Code) Validate() error {
	...
	return util.NewErrValueInvalid("InvestigatedParties1Code")
}
