...
func (*FP111001I) GetServiceKey() string {
	return "FP111001"
}

type FP111001O struct {
	ClrSysRef             string `json:"clrSysRef" `
	ClrSysId              string `json:"clrSysId" `
	MsgId                 string `json:"msgId" `
	FromMemberId          string `json:"fromMemberId" `
...
type FP111001Outgress struct {
	Body []byte `json:"body"`
}

func (*FP111001Outgress) GetServiceKey() string {
	return "FP210002"
}

type FP111001OutgressResponse struct {
	Body []byte `json:"body"`
}
