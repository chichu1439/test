...
func (*FP110016I) GetServiceKey() string {
	return "FP110016"
}

type FP110016O struct {
	ClrSysRef             string `json:"clrSysRef"`
	ClrSysId              string `json:"clrSysId"`
	MsgId                 string `json:"msgId"`
	FromMemberId          string `json:"fromMemberId"`
...
type FP110016Outgress struct {
	Body []byte `json:"body"`
}

func (*FP110016Outgress) GetServiceKey() string {
	return "FP210002"
}

type FP110016OutgressResponse struct {
	Body []byte `json:"body"`
}
