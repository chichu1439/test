...
type SV000021I struct {
	...
	MediaType                 string    `validate:"max=3" json:"mediaType" description:"Media type"`               //介质类型 VCD-虚拟卡
	...
	CanEm                     string    `json:"canEm" description:"Sales teller"`
	CanPrvEm                  string    `json:"canPrvEm" description:"Sales Authorized Teller"`
	CanReason                 string    `json:"canReason" description:"cancel reason"`
	SettlementId              string    `json:"settlementId" description:"settlementId"`
	FeeArray                  []FeeInfo `json:"feeArray" description:"Fee array" validate:"dive"`
	ExternalSystem            string    `json:"externalSystem" description:"External system"`
	ExternalSystemFlow        string    `json:"externalSystemFlow" description:"External system flow"`
	FeeDeductionMediaNM       string    `json:"feeDeductionMediaNm" description:"Fee deduction media n m"`
	FeeDeductionMediamType    string    `json:"feeDeductionMediamType" description:"Fee deduction mediam type"`
	FeeDeductionCurrency      string    `json:"feeDeductionCurrency" description:"Fee deduction currency"`
	FeeDeductioncashTransFlag string    `json:"feeDeductioncashTransFlag" description:"Fee deductioncash trans flag"`
	FeeDeductionChannel       string    `json:"feeDeductionChannel" description:"Fee deduction channel"`
	FeeusageCode              string    `json:"feeusageCode" description:"Feeusage code"`
	FeeDedwithdrawMeth        string    `json:"feeDedwithdrawMeth" description:"Fee dedwithdraw meth"`
	FeeNeedPasswordFlag       string    `json:"feeNeedPasswordFlag" description:"Fee need password flag"`
	FeeaccountPassword        string    `json:"feeaccountPassword" description:"Feeaccount password"`
}
