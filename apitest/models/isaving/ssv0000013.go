...
type SV000013I struct {
	...
	FreezeMode              string  `json:"freezeMode" validate:"required,max=1,oneof=3" description:"Freezing method"`                        //冻结方式 1-账户冻结，2-金额冻结 3-暂禁
	...
	BankFreezeType          string  `json:"bankFreezeType" validate:"required,max=1,oneof=M T" description:"Bank freeze distinction"`
}

type SV000013O struct {
...
func (*SV000013I) GetServiceKey() string {
	return "ssv0000013"
}
