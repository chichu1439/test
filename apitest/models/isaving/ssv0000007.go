...
type SSV0000007I struct {
	...
	UnfreezeMode              string  `json:"unfreezeMode" validate:"required,max=1,oneof=1 2 3" description:"UnFreeze Mode"`                //解冻方式 1-账户冻结解冻，2-全部金额解冻，3-部分金额解冻
	...
	UsageCode                 string  `json:"usageCode" validate:"max=3" description:"Purpose code"`                                         //用途代码 当查询输入类型是2时
	...
	EnforcerName1             string  `json:"enforcerName1" validate:"max=60" description:"Name of law enforcement officer 1"`               //解冻执法人员名称1
	EnforcerId1               string  `json:"enforcerId1" validate:"max=60" description:"Law enforcement officer ID number 1"`               //解冻执法人员证件号码1
...
type SSV0000007O struct {
}

func (*SSV0000007I) GetServiceKey() string {
	return "ssv0000007"
}
