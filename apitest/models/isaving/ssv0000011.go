...
type SSV0000011I struct {
	...
	MediaType          string `valid:"required,max=3" json:"mediaType" description:"Media type"`                         //介质类型
	MediaNumber        string `valid:"required,max=30" json:"mediaNumber" description:"Media number"`                    //介质号码
