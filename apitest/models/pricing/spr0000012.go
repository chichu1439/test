...
type SPR0000012I struct {
	...
	WithdrawMethod            string              `json:"withdrawMethod" description:"Withdrawal way(0-password;1-seal;2-signature;3-fingerprint)" description:"Whether it needs to be inspected(Y-need to verify the secret; N-do not need to verify the secret)"` //支取方式
	...
	FeeArray                  []SPR0000012FeeInfo `json:"feeArray" description:"Fee array"`
}

type SPR0000012FeeInfo struct {
...
type SPR0000012O struct {
}

func (*SPR0000012I) GetServiceKey() string {
	return "spr0000012"
}
