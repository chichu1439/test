...
type PF000002I struct {
	...
	ListFeeId       []string `json:"listFeeId" description:"List fee id"`
...
type PriceFeeItemList struct {
	...
	ListStrategy       []ListStrategy02 `json:"listStrategy" description:"List strategy"`
}

type ListStrategy02 struct {
