...
type FPSB2BPacs008s struct {
	FPSB2BPacs008
	ClrRefId string `json:"clrRefId"`
}

type FPSB2BPacs008 struct {
	XMLName  xml.Name `xml:"FpsMsg"`
	NumOfMsg string   `xml:"NbOfMsgs"`
	// TODO 好像没有Head
	XMLHead  HeadB2B001 `xml:"FpsPylds>BizData>AppHdr"`
	Document PacsB2B008 `xml:"FpsPylds>BizData>Document"`
}

type PacsB2B008 struct {
	...
	ClrSysCode           string   `xml:"FIToFICstmrCdtTrf>GrpHdr>SttlmInf>ClrSys>Cd,omitempty" validate:"required,max=35"` //itmx add
