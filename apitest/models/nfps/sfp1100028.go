...
type FP110028I struct {
	...
	ITMXSegment          ITMXBillPayment      `json:"itmxSegment" validate:"required"`
...
type FP110028O struct {
	...
	ITMXSegment          ITMXBillPayment      `json:"itmxSegment"`
...
func (*FP110028I) GetServiceKey() string {
	return "FP110028"
}
