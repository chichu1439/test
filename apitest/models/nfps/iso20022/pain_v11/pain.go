...
type CurrencyExchange13 struct {
	SrcCcy   common.ActiveCurrencyCode  `xml:"SrcCcy"`
	TrgtCcy  common.ActiveCurrencyCode  `xml:"TrgtCcy"`
	XchgRate float64                    `xml:"XchgRate"`
	UnitCcy  *common.ActiveCurrencyCode `xml:"UnitCcy,omitempty" json:",omitempty"`
}

func (r CurrencyExchange13) Validate() error {
	return util.Validate(&r)
}
...
func (r CustomerPaymentStatusReportV11) Validate() error {
	return util.Validate(&r)
}
...
func (r GroupHeader86) Validate() error {
	return util.Validate(&r)
}
...
type OriginalPaymentInstruction38 struct {
	...
	StsRsnInf     []StatusReasonInformation12      `xml:"StsRsnInf,omitempty" json:",omitempty"`
	NbOfTxsPerSts []NumberOfTransactionsPerStatus5 `xml:"NbOfTxsPerSts,omitempty" json:",omitempty"`
	TxInfAndSts   []PaymentTransaction126          `xml:"TxInfAndSts,omitempty" json:",omitempty"`
}

func (r OriginalPaymentInstruction38) Validate() error {
	return util.Validate(&r)
}
...
type PaymentTransaction126 struct {
	...
	TrckrData       *TrackerData1                          `xml:"TrckrData,omitempty" json:",omitempty"`
...
func (r PaymentTransaction126) Validate() error {
	return util.Validate(&r)
}
...
type TrackerRecord1 struct {
	...
	ChrgsAmt     *ActiveCurrencyAndAmount                      `xml:"ChrgsAmt,omitempty" json:",omitempty"`
	XchgRateData *CurrencyExchange13                           `xml:"XchgRateData,omitempty" json:",omitempty"`
}

func (r TrackerRecord1) Validate() error {
	return util.Validate(&r)
}
