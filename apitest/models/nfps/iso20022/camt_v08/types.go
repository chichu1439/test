...
func (r ExternalCancellationReason1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalCancellationReason1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalBalanceSubType1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalBalanceSubType1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalBalanceType1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalBalanceType1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalBankTransactionDomain1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalBankTransactionDomain1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalBankTransactionFamily1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalBankTransactionFamily1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalBankTransactionSubFamily1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalBankTransactionSubFamily1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalCardTransactionCategory1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalCardTransactionCategory1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalChargeType1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalChargeType1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalCreditLineType1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalCreditLineType1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalEntryStatus1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalEntryStatus1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalFinancialInstrumentIdentificationType1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalFinancialInstrumentIdentificationType1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalRePresentmentReason1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalRePresentmentReason1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalReportingSource1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalReportingSource1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalReturnReason1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalReturnReason1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalTechnicalInputChannel1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalTechnicalInputChannel1Code", 1, 4)
	}
	return nil
}
...
func (r BalanceStatus1Code) Validate() error {
	...
	return util.NewErrValueInvalid("BalanceStatus1Code")
}
...
func (r ProcessingType1Code) Validate() error {
	...
	return util.NewErrValueInvalid("ProcessingType1Code")
}
...
func (r StandingOrderType1Code) Validate() error {
	...
	return util.NewErrValueInvalid("StandingOrderType1Code")
}
...
func (r SystemBalanceType2Code) Validate() error {
	...
	return util.NewErrValueInvalid("SystemBalanceType2Code")
}
...
func (r CashPaymentStatus2Code) Validate() error {
	...
	return util.NewErrValueInvalid("CashPaymentStatus2Code")
}
...
func (r EntryStatus1Code) Validate() error {
	...
	return util.NewErrValueInvalid("EntryStatus1Code")
}
...
func (r FinalStatusCode) Validate() error {
	...
	return util.NewErrValueInvalid("FinalStatusCode")
}
...
func (r Instruction1Code) Validate() error {
	...
	return util.NewErrValueInvalid("Instruction1Code")
}
...
func (r PaymentInstrument1Code) Validate() error {
	...
	return util.NewErrValueInvalid("PaymentInstrument1Code")
}
...
func (r PendingStatus4Code) Validate() error {
	...
	return util.NewErrValueInvalid("PendingStatus4Code")
}
...
func (r Priority5Code) Validate() error {
	...
	return util.NewErrValueInvalid("Priority5Code")
}
...
func (r ReportIndicator1Code) Validate() error {
	...
	return util.NewErrValueInvalid("ReportIndicator1Code")
}
...
func (r CancelledStatusReason1Code) Validate() error {
	...
	return util.NewErrValueInvalid("CancelledStatusReason1Code")
}
...
func (r FinalStatus1Code) Validate() error {
	...
	return util.NewErrValueInvalid("FinalStatus1Code")
}
...
func (r PendingFailingSettlement1Code) Validate() error {
	...
	return util.NewErrValueInvalid("PendingFailingSettlement1Code")
}
...
func (r PendingSettlement2Code) Validate() error {
	...
	return util.NewErrValueInvalid("PendingSettlement2Code")
}
...
func (r SuspendedStatusReason1Code) Validate() error {
	...
	return util.NewErrValueInvalid("SuspendedStatusReason1Code")
}
...
func (r UnmatchedStatusReason1Code) Validate() error {
	...
	return util.NewErrValueInvalid("UnmatchedStatusReason1Code")
}
...
func (r LimitStatus1Code) Validate() error {
	...
	return util.NewErrValueInvalid("LimitStatus1Code")
}
...
func (r AttendanceContext1Code) Validate() error {
	...
	return util.NewErrValueInvalid("AttendanceContext1Code")
}
...
func (r AuthenticationEntity1Code) Validate() error {
	...
	return util.NewErrValueInvalid("AuthenticationEntity1Code")
}
...
func (r AuthenticationMethod1Code) Validate() error {
	...
	return util.NewErrValueInvalid("AuthenticationMethod1Code")
}
...
func (r CSCManagement1Code) Validate() error {
	...
	return util.NewErrValueInvalid("CSCManagement1Code")
}
...
func (r CardDataReading1Code) Validate() error {
	...
	return util.NewErrValueInvalid("CardDataReading1Code")
}
...
func (r CardPaymentServiceType2Code) Validate() error {
	...
	return util.NewErrValueInvalid("CardPaymentServiceType2Code")
}
...
func (r CardholderVerificationCapability1Code) Validate() error {
	...
	return util.NewErrValueInvalid("CardholderVerificationCapability1Code")
}
...
func (r OnLineCapability1Code) Validate() error {
	...
	return util.NewErrValueInvalid("OnLineCapability1Code")
}
...
func (r POIComponentType1Code) Validate() error {
	...
	return util.NewErrValueInvalid("POIComponentType1Code")
}
...
func (r PartyType3Code) Validate() error {
	...
	return util.NewErrValueInvalid("PartyType3Code")
}
...
func (r PartyType4Code) Validate() error {
	...
	return util.NewErrValueInvalid("PartyType4Code")
}
...
func (r PriceValueType1Code) Validate() error {
	...
	return util.NewErrValueInvalid("PriceValueType1Code")
}
...
func (r TransactionChannel1Code) Validate() error {
	...
	return util.NewErrValueInvalid("TransactionChannel1Code")
}
...
func (r TransactionEnvironment1Code) Validate() error {
	...
	return util.NewErrValueInvalid("TransactionEnvironment1Code")
}
...
func (r UnitOfMeasure1Code) Validate() error {
	...
	return util.NewErrValueInvalid("UnitOfMeasure1Code")
}
...
func (r UserInterface2Code) Validate() error {
	...
	return util.NewErrValueInvalid("UserInterface2Code")
}
...
func (r Exact3NumericText) Validate() error {
	...
	if !reg.MatchString(string(r)) {
		return util.NewErrValueInvalid("Exact3NumericText")
	}
	return nil
}
...
func (r ISO2ALanguageCode) Validate() error {
	...
	if !reg.MatchString(string(r)) {
		return util.NewErrValueInvalid("ISO2ALanguageCode")
	}
	return nil
}
...
func (r EntryTypeIdentifier) Validate() error {
	...
	if !reg.MatchString(string(r)) {
		return util.NewErrValueInvalid("EntryTypeIdentifier")
	}
	return nil
}
