...
func (r ExternalMandateStatus1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalMandateStatus1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalMandateSuspensionReason1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalMandateSuspensionReason1Code", 1, 4)
	}
	return nil
}
