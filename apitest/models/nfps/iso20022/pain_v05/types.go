...
func (r ExternalAuthenticationChannel1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalAuthenticationChannel1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalMandateReason1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalMandateReason1Code", 1, 4)
	}
	return nil
}
...
func (r SequenceType2Code) Validate() error {
	...
	return util.NewErrValueInvalid("SequenceType2Code")
}
...
func (r ExternalStatusReason1Code) Validate() error {
	if len(string(r)) < 1 {
		return util.NewErrTextLengthInvalid("ExternalStatusReason1Code", 1, 0)
	}
	return nil
}
...
func (r TransactionGroupStatus3Code) Validate() error {
	...
	return util.NewErrValueInvalid("TransactionGroupStatus3Code")
}
...
func (r TransactionIndividualStatus3Code) Validate() error {
	...
	return util.NewErrValueInvalid("TransactionIndividualStatus3Code")
}
