...
type ProxyAccountType1Choice struct {
	...
	Cd    common.Max16Text `xml:"Cd,omitempty" json:",omitempty"` //temp change
...
func (r CashAccount40) Validate() error {
	return util.Validate(&r)
}
...
func (r IdentificationAssignment3) Validate() error {
	return util.Validate(&r)
}
...
func (r IdentificationInformation4) Validate() error {
	return util.Validate(&r)
}
...
func (r IdentificationVerification4) Validate() error {
	return util.Validate(&r)
}
...
type IdentificationVerificationRequestV03 struct {
	...
	Vrfctn      []*IdentificationVerification4 `xml:"Vrfctn" json:",omitempty"`
	SplmtryData []*SupplementaryData1          `xml:"SplmtryData,omitempty" json:",omitempty"`
}

func (r IdentificationVerificationRequestV03) Validate() error {
	return util.Validate(&r)
}
