...
func (r SettlementMethod2Code) Validate() error {
	...
	return util.NewErrValueInvalid("SettlementMethod2Code")
}
...
func (r ExternalPaymentGroupStatus1Code) Validate() error {
	if len(string(r)) < 1 {
		return util.NewErrTextLengthInvalid("ExternalPaymentGroupStatus1Code", 1, 0)
	}
	return nil
}
...
func (r ExternalPaymentTransactionStatus1Code) String() string {
	return string(r)
}
func (r ExternalPaymentTransactionStatus1Code) Validate() error {
	if len(string(r)) < 1 {
		return util.NewErrTextLengthInvalid("ExternalPaymentTransactionStatus1Code", 1, 0)
	}
	return nil
}
...
func (r ExternalStatusReason1Code) String() string {
	return string(r)
}
