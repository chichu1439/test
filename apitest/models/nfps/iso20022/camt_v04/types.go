...
func (r ExternalSystemMemberType1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalSystemMemberType1Code", 1, 4)
	}
	return nil
}
...
func (r ExternalPaymentRole1Code) Validate() error {
	if len(string(r)) < 1 || len(string(r)) > 4 {
		return util.NewErrTextLengthInvalid("ExternalPaymentRole1Code", 1, 4)
	}
	return nil
}
...
func (r MemberStatus1Code) Validate() error {
	...
	return util.NewErrValueInvalid("MemberStatus1Code")
}
...
func (r ErrorHandling1Code) Validate() error {
	...
	return util.NewErrValueInvalid("ErrorHandling1Code")
}
