...
type FP010016I struct {
	Data string `json:"data" validate:"required"`
}

type FP010016O struct {
	Data string `json:"data" validate:"required"`
}

var Spec0200 = &iso8583.MessageSpec{
...
type ISO85830200F43Data struct {
	F1 *field.String
	F2 *field.String
	F3 *field.String
	F4 *field.String
...
type ISO85830200F48Data struct {
	F1  *field.String
	F2  *field.String
	F3  *field.String
	F4  *field.String
...
type ISO85830200F62Data struct {
	F1  *field.String
	F2  *field.String
	F3  *field.String
	F4  *field.String
...
type ISO85830210Data struct {
	...
	F41  *field.String
	F42  *field.String
	F43  *ISO85830210F43Data
	F44  *field.String
	F45  *field.String
	F46  *field.String
	F47  *field.String
	F48  *ISO85830210F48Data
	F49  *field.String
	F50  *field.String
	F51  *field.String
	F52  *field.String
...
type ISO85830210F43Data struct {
	F1 *field.String
	F2 *field.String
	F3 *field.String
	F4 *field.String
...
type ISO85830210F48Data struct {
	F1  *field.String
	F2  *field.String
	F3  *field.String
	F4  *field.String
...
type ISO85830210F62Data struct {
	F1  *field.String
	F2  *field.String
	F3  *field.String
	F4  *field.String
...
var Right func(pad rune) padding.Padder = NewRightPadder

type RightPadder struct {
	pad []byte
}

func NewRightPadder(pad rune) padding.Padder {
...
func (p *RightPadder) Pad(data []byte, length int) []byte {
	...
	return append(data, bytes.Repeat(p.pad, length-len(data))...)
}
