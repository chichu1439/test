...
func (*FP113021I) GetServiceKey() string {
	return "FP113021"
}

type FP113021O struct {
	MsgId                 string `json:"msgId"`
	FromMemberId          string `json:"fromMemberId" `
	ToMemberId            string `json:"toMemberId" `
	TransStatus           string `json:"transStatus"`
...
type FP113021Outgress struct {
	Body []byte `json:"body"`
}

func (*FP113021Outgress) GetServiceKey() string {
	return "FP213021"
}

type FP113021OutgressResponse struct {
	Body []byte `json:"body"`
}
