...
func (*FP112016I) GetServiceKey() string {
	return "FP112016"
}

type FP112016O struct {
	ClrSysRef             string `json:"clrSysRef"`
	ClrSysId              string `json:"clrSysId"`
	MsgId                 string `json:"msgId"`
	FromMemberId          string `json:"fromMemberId"`
...
type FP112016Outgress struct {
	Body []byte `json:"body"`
}

func (*FP112016Outgress) GetServiceKey() string {
	return "FP212016"
}

type FP112016OutgressResponse struct {
	Body []byte `json:"body"`
}
