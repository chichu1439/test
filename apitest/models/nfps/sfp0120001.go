...
type FP012001I struct {
	...
	FP012001IDoc FP012001IDoc `xml:"FpsPylds>BizData>Document"`
}

type FP012001IDoc struct {
...
type FP012001O struct {
}

func (*FP012001I) GetServiceKey() string {
	return "FP012001"
}
