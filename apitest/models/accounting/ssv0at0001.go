...
type SV0AT001I struct {
	...
	Item              []SSV0AT000001IItem `json:"item" description:"Item"`
}

type SSV0AT000001IItem struct {
...
type SV0AT001O struct {
}

func (*SV0AT001I) GetServiceKey() string {
	return "ssv0at0001"
}
