...
type AC000012I struct {
	...
	TransFlow              string `json:"transFlow" validate:"required,max=10" description:"Trade time"`
}

type AC000012O struct {
...
func (*AC000012I) GetServiceKey() string {
	return "sac0000012"
}
