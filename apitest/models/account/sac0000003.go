...
type SAC0000003I struct {
	AccountArray []SAC0000003IAccountInfo `json:"accountArray" description:"Account array"`
}

type SAC0000003IAccountInfo struct {
...
type SAC0000003O struct {
	ResultArray []SAC0000003OResultInfo `json:"resultArray" description:"Result array"`
}

type SAC0000003OResultInfo struct {
...
func (*SAC0000003I) GetServiceKey() string {
	return "sac0000003"
}
