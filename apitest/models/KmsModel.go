...
//AddCertWithCrypto request

type AddSecretWithCryptoI struct {
 ServiceId string      `json:"serviceId" description:"Service id"` 
 Operator  string      `json:"operator" description:"Operator"` 
 Secret    []SecretObj `json:"secret" description:"Secret"` 
}
...
type AddSecretWithCryptoO struct {
	Response string `json:"response"`
}

type GetSecretWithCryptoI struct {
	ServiceId string   `json:"serviceId"`
	Operator  string   `json:"operator"`
	Keys      []string `json:"keys"`
}

type GetSecretWithCryptoO struct {
	Secret []SecretObj `json:"secret"`
}
